...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "NodeMap — Elige tu modalidad" },
      {
        name: "description",
        content:
          "NodeMap: red P2P para uso público y entornos corporativos. Elige entre Consumer o Work para acceder.",
      },
      { property: "og:title", content: "NodeMap — Elige tu modalidad" },
      {
        property: "og:description",
        content: "Red P2P pública o entorno empresarial seguro. Elige tu acceso.",
      },
    ],
  }),
  component: Index,
...
function ModeCard({ variant, icon, titleMain, titleAccent, description, tag, cta }: CardProps) {
